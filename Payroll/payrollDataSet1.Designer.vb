...
Partial Public Class payrollDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal emp_num As String, ByVal lname As String, ByVal fname As String, ByVal mname As String, ByVal bday As Date, ByVal rate As Decimal) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, emp_num, lname, fname, mname, bday, rate}
...
Namespace payrollDataSetTableAdapters
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`emp_num`, `lname`, `fname`, `mname`, `bday`, `rate`) VAL"& _ 
                "UES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Employee` SET `emp_num` = ?, `lname` = ?, `fname` = ?, `mname` = ?, `bday"& _ 
                "` = ?, `rate` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `emp_num` IS NULL) OR (`emp_"& _ 
                "num` = ?)) AND ((? = 1 AND `lname` IS NULL) OR (`lname` = ?)) AND ((? = 1 AND `f"& _ 
                "name` IS NULL) OR (`fname` = ?)) AND ((? = 1 AND `mname` IS NULL) OR (`mname` = "& _ 
                "?)) AND ((? = 1 AND `bday` IS NULL) OR (`bday` = ?)) AND ((? = 1 AND `rate` IS N"& _ 
                "ULL) OR (`rate` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, emp_num, lname, fname, mname, bday, rate FROM Employee"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_emp_num As String, ByVal Original_lname As String, ByVal Original_fname As String, ByVal Original_mname As String, ByVal Original_bday As Global.System.Nullable(Of Date), ByVal Original_rate As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal emp_num As String, ByVal lname As String, ByVal fname As String, ByVal mname As String, ByVal bday As Global.System.Nullable(Of Date), ByVal rate As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal emp_num As String, ByVal lname As String, ByVal fname As String, ByVal mname As String, ByVal bday As Global.System.Nullable(Of Date), ByVal rate As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_emp_num As String, ByVal Original_lname As String, ByVal Original_fname As String, ByVal Original_mname As String, ByVal Original_bday As Global.System.Nullable(Of Date), ByVal Original_rate As Global.System.Nullable(Of Decimal)) As Integer
            If (emp_num Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_emp_num,String)
            End If
            If (Original_lname Is Nothing) Then
            ...
            If (Original_bday.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_bday.Value,Date)
            Else
    ...
    Partial Public Class UsersTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As payrollDataSet.UsersDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As payrollDataSet.UsersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As payrollDataSet.UsersDataTable = New payrollDataSet.UsersDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As payrollDataSet.UsersDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
